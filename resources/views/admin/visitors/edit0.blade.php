...
<!--                <input class="form-control datetime {{ $errors->has('in_date_time') ? 'is-invalid' : '' }}" type="datetime-local" name="in_date_time" id="in_date_time" value="{{ old('in_date_time', $visitor->in_date_time) }}">-->
...
<!--                <input class="form-control datetime {{ $errors->has('out_date_time') ? 'is-invalid' : '' }}" type="datetime-local" name="out_date_time" id="out_date_time" value="{{ old('out_date_time', $visitor->out_date_time) }}">-->
