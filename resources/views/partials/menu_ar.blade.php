                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/governorates*") ? "menu-open" : "" }} {{ request()->is("admin/departements*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                               ...
                               @can('deposit_type_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.deposit-types.index") }}" class="nav-link {{ request()->is("admin/deposit-types") || request()->is("admin/deposit-types/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.depositType.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
